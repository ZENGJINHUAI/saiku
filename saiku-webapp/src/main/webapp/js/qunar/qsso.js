    ...
    var QSSO = (function () {
        ...
        return {
            'auth': function (loginURI, opt_ext) {
                if (!location.hostname.match(/\.qunar(man|ops)?\.com$|qunar\.it$|\.928383\.com$|^928383\.com$|qunar\.ctripgroup\.com$|\.ctrip(corp)?\.com$|^opsdata\.me$|\.mofun\.com$/i)) {
