...
public class RepositoryDatasourceManager implements IDatasourceManager {
    ...
    public void load() {
        ...
        if (type.equals("classpath")) {
            ...
            irm = ClassPathRepositoryManager
                    .getClassPathRepositoryManager(cleanse(datadir), defaultRole, sessionRegistry, workspaces);
            log.debug("2nd init datadir= " + datadir);
        } else {
            irm = JackRabbitRepositoryManager
                    .getJackRabbitRepositoryManager(configurationpath, datadir, repopasswordprovider.getPassword(),
            ...
            while (i < exporteddatasources.size()) {
                ...
                try {
                    if (file.getName() != null && file.getType() != null) {
                        ...
                        } else if (file.getPropertyKey() != null && ext
                                .containsKey("datasource." + file.getPropertyKey() + ".driver")) {
                            String p = ext.getProperty("datasource." + file.getPropertyKey() + ".driver");
                            props.put("driver", p);
                        }
                        if (file.getPropertyKey() != null && ext
                                .containsKey("datasource." + file.getPropertyKey() + ".location")) {
                        ...
                        if (file.getUsername() != null && file.getPropertyKey() == null) {
                            props.put("username", file.getUsername());
                                ...
                                .containsKey("datasource." + file.getPropertyKey() + ".username")) {
                        ...
                        if (file.getPassword() != null && file.getPropertyKey() == null) {
                            props.put("password", file.getPassword());
                                ...
                                .containsKey("datasource." + file.getPropertyKey() + ".password")) {
                        ...
                        if (file.getPath() != null) {
                            props.put("path", file.getPath());
                                ...
                                .containsKey("datasource." + file.getPropertyKey() + ".path")) {
                        ...
                        if (file.getSecurityenabled() != null) {
                            props.put("security.enabled", file.getSecurityenabled());
                                ...
                                .containsKey("datasource." + file.getPropertyKey() + ".security.enabled")) {
                        ...
                        if (file.getSecuritytype() != null) {
                            props.put("security.type", file.getSecuritytype());
                                ...
                                .containsKey("datasource." + file.getPropertyKey() + ".security.type")) {
                        ...
                        if (file.getSecuritymapping() != null) {
                            props.put("security.mapping", file.getSecuritymapping());
                                ...
                                .containsKey("datasource." + file.getPropertyKey() + ".security.mapping")) {
    ...
    public SaikuDatasource addDatasource(SaikuDatasource datasource) throws Exception {
        ...
        if (ds.getCsv() != null && ds.getCsv().equals("true")) {
            ...
            boolean f = true;
            if (new File(getDatadir() + separator + path).exists() && new File(getDatadir() + separator + path)
                    .isDirectory()) {
                f = false;
            }
            irm.saveInternalFile(this.getCSVJson(f, ds.getName(), getDatadir() + path),
                    separator + "datasources" + separator + ds.getName() + "-csv.json", "fixme");
